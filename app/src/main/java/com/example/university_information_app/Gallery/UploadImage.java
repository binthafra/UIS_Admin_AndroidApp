package com.example.university_information_app.Gallery;
...
public class UploadImage extends AppCompatActivity {
    ...
    private String category;   //store the category which admin select
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category","Convocation","Independence Day","Tech Fest"};
