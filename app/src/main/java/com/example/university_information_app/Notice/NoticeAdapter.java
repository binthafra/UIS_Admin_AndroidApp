...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.NoticeViewAdapter> {
   ...
   private ArrayList<NoticeData> list;
    ...
    public void onBindViewHolder(@NonNull NoticeViewAdapter holder, final int position) {
        ...
        holder.deleteNoticeTittle.setText(currentItem.getTittle());
    ...
    public class NoticeViewAdapter extends RecyclerView.ViewHolder {
        ...
        private TextView deleteNoticeTittle;
        private ImageView deleteNoticeImage;
        //constructor
        public NoticeViewAdapter(@NonNull View itemView) {
            super(itemView);
            deleteNoticeBtn = itemView.findViewById(R.id.deleteNoticeBtn);
            deleteNoticeTittle =itemView.findViewById(R.id.deleteNoticeTittle);
