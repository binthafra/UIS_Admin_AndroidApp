...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Values of Teacher in UpdateTeacher View
        try {
        ...
        //When click On updateTeacher Image then open image Gallery
          ...
          databaseReference.child(category).child(uniqueKey).removeValue()
                  .addOnCompleteListener(new OnCompleteListener<Void>() {
                      ...
                      public void onComplete(@NonNull Task<Void> task) {
                          ...
                          // After Update when we press "BAck" it will goto updateTeacherActivity
                          //it will open home page==so we add flag
    ...
    private void updateData(String s) {
        ...
        //as many category we can find the exact category by their unique key
        // String uniqueKey = getIntent().getStringExtra("key");
        //String category = getIntent().getStringExtra("category");

        databaseReference.child(category).child(uniqueKey).updateChildren(hashMap)
